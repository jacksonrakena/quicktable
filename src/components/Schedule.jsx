...
export default class Schedule extends Component {
    ...
    render() {
        console.log('render: ' + this.state.date.toFormat('dd/LL/yyyy'))
        {
            if (this.state.error) {
                return <div class="container h-100 d-flex justify-content-center align-content-center">
                ...
                return <div class="container h-100 flex-column justify-content-center align-content-center">
